            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form action="verify.php" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" name="confPassword" class="form-control form-control-xl" placeholder="Confirm Password">
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
                        <button name="register" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Sign Up</button>
                    </form>
                </div>
            </div>
